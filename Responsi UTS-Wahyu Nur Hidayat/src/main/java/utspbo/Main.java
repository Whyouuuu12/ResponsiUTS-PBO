...
public class Main {
    public static void main(String[] args) {
        ...
        Produk produk2 = new Makanan("Snack", 15000, "30-12-2023");

        // Polimorfisme untuk Pegawai
        Pegawai pegawai1 = new PegawaiTetap("Wahyu", 5000000, 1000000);
        Pegawai pegawai2 = new PegawaiKontrak("Dayat", 3000000, 12);

        // Memanggil metode tampilkanInfo() dengan referensi induk
